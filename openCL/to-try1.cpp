...
int main()
{
    ...
    piece_mem = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_COPY_HOST_PTR, 4096 * sizeof(unsigned char), &chunk, &err);
    ...
    */
	...
	program = clCreateProgramWithSource(context, 1, OpenCLSource, NULL, NULL);
    ...
    CL_CHECK(clEnqueueTask(command_queue, kernel, 0, NULL, NULL));
